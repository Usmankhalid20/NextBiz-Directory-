...
export default async function BusinessDetailsPage({ params }) {
  ...
  // Serialize dates and ID
  business._id = business.id = business._id.toString();
  business.createdAt = business.createdAt?.toISOString();
  business.updatedAt = business.updatedAt?.toISOString();
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
                ...
                {/* Gallery (Placeholder if you have images later) */}
                {/* 
                <section className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-start">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">{business.city}, {business.state} {business.zipCode}</p>
                            </div>
                        </div>
